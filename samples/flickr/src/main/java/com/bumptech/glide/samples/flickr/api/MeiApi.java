...
public class MeiApi {
  ...
  public static MeiApi get(Context context) {
    if (api == null) {
      api = new MeiApi(context);
    }
    return api;
  }
  ...
  protected MeiApi(Context context) {
  ...
  public void query(Query query) {
    ...
    MeiQueryResponseListener responseListener
        = new MeiQueryResponseListener(new PhotoJsonStringParser(), query, queryListeners);
